    ...
    <SafeAreaView style={styles.container}>
        <ScrollView style={styles.scrollView}>  
           ...
           {/* <View>
              ...
              <View style={styles.view_Nomarl}>
                <Text style={styles.text_Nomarl}>
                        {"Enter your Name, Email and Password for sign up."}
                        <Text style={styles.Textgreen

}>{"Arealy have account?"}</Text>
                </Text>
            ...
            <View style={styles.column}>
                <View style={styles.view}>
                    <View style={styles.create_Boder}>
                        <View style={styles.View_Input}>
                            <Image
                                source = {{uri: "https://cdn2.iconfinder.com/data/icons/social-productivity-line-art-2/128/message-1024.png"}} 
                                resizeMode = {"stretch"}
                                style={styles.image}
                            />
                            <TextInput
